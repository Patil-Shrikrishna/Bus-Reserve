...
const BusDetailCard = (props) => {
  ...
  return (
    <div className="flex flex-col border border-custom-darkgray rounded-lg w-full ">
      ...
      >
        {/* Line 1: */}
        <Heading heading="Select Seats" className="font-bold" />
        {/* Line 2: */}
        ...
        <div className="flex gap-2 sm:flex-row flex-col ">
          <div className="flex flex-col w-full sm:w-2/3 h-fit justify-center items-center border border-custom-darkgray ">
            <div className="flex gap-2 w-fit -rotate-90 -my-24 sm:-my-32">
              <SeatLayout berth="Upper Berth" />
            </div>
            <div className="flex gap-2 w-fit -rotate-90 -my-24">
              <SeatLayout berth="Lower Berth" />
            </div>
          </div>
          {/* column 2 */}
          <div className=" border border-custom-darkgray p-4 w-1/3">
            {/* Line 1  */}
            <Heading
            ...
            <div className="flex flex-col">
              <div className="flex justify-between">
                {/* Line 1  */}
                <Heading heading="Ahmedabad" className="text-lg font-bold" />
                {/* Line 1  */}
                <Heading heading="07:00" className="text-lg font-bold" />
              </div>
              <div className="flex justify-between">
                {/* Line 1  */}
                <Heading heading="Delhi" className="text-lg font-bold" />
                {/* Line 1  */}
                <Heading heading="15:00" className="text-lg font-bold" />
              </div>
            </div>
            {/* Line 3  */}
            ...
            {/* Line 4  */}
            <Heading heading="Fare Details" className="text-2xl font-bold" />
            {/* Line 5  */}
            <div className="flex justify-between">
              <Heading heading="Amount" className="text-lg font-bold" />
              <Heading heading="INR: 1798" className="text-lg font-bold" />
            </div>
            <Button
